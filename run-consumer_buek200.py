        ...
        if is_data_row:
            ...
            if not os.path.isfile(path_to_row_file):
                with open(path_to_row_file, "w") as _:
                    _.write("CM-count,row,col,Crop,Year,SowDOY,HarvDOY,SowYear,Cycle-length,RelDev, Yield-last,LAI-max,TraDef-avg,NDef-avg,crop-sum-nfert,Nmin-sum,ActNup-sum,NO3-sum,NH4-sum,NO2-sum, avg-30cm-sand, avg-30cm-clay, avg-30cm-silt, avg-30cm-stone, crop-sum-nleach\n")
